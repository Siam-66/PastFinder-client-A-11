...
<Link to="/allArtifacts" className="link link-hover">All Artifacts</Link>
<Link to="/myArtifacts" className="link link-hover">My Artifacts</Link>
<Link to="/myAddedArtifacts" className="link link-hover">My Added Artifacts</Link>
...
<p className="text-center text-black">Copyright © {new Date().getFullYear()} - All right reserved by Lingo Bingo Ltd.</p>
</div>
    </div>
    );
};
